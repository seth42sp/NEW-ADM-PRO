...
"dns-netflix.sh")ARQ="${SCPinst}/";; #Instalacao
...
# Instala��o NEW-ADM-PRO
fun_ip
wget -O /usr/bin/trans http://git.io/trans &> /dev/null
clear
msg -bar2
msg -ama "[ NEW-ADM-PRO - SCRIPT ]    \033[1;37m@seth42sp"
[[ $1 = "" ]] && funcao_idioma || {
...
if [[ -e $HOME/lista-arq ]] && [[ ! $(cat $HOME/lista-arq|grep "KEY INVALIDA!") ]]; then
   msg -bar2
   msg -ama "$(source trans -b pt:${id} "BEM VINDO, OBRIGADO POR UTILIZAR"|sed -e 's/[^a-z -]//ig'): \033[1;31m[NEW-ADM-PRO]"
   ...
   wget -O $HOME/LICENCIA.txt https://raw.githubusercontent.com/seth42sp/NEW-ADM-PRO/main/LICENCIA.txt &> /dev/null
   wget -O $HOME/versao https://raw.githubusercontent.com/seth42sp/NEW-ADM-PRO/main/versao &> /dev/null
   wget -O /bin/versao_script https://raw.githubusercontent.com/seth42sp/NEW-ADM-PRO/main/Install/versaoatt &> /dev/null
   inst_components
   install_hosts
