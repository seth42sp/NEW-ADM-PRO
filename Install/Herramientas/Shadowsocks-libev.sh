...
1)
msg -bar
wget --no-check-certificate -O Instalador-Shadowsocks-libev.sh https://raw.githubusercontent.com/VPS-MX/VPS-MX-8.0/main/ArchivosUtilitarios/Instalador-Shadowsocks-libev.sh > /dev/null 2>&1
