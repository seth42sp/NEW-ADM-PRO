...
fun_nettools () {
[[ ! -e /bin/nettools.py ]] && wget -O /bin/nettools.py https://raw.githubusercontent.com/seth42sp/NEW-ADM-PRO/main/Install/nettools.py > /dev/null 2>&1; chmod +x /bin/nettools.py; /bin/nettools.py
}
...
fun_cssr () {
wget -O /bin/C-SSR.sh https://raw.githubusercontent.com/seth42sp/NEW-ADM-PRO/main/Install/Herramientas/C-SSR.sh
chmod +x /bin/C-SSR.sh; C-SSR.sh
exit
}

fun_shadowsockslibev () {
wget -O /bin/Shadowsocks-libev.sh https://raw.githubusercontent.com/seth42sp/NEW-ADM-PRO/main/Install/Herramientas/Shadowsocks-libev.sh
chmod +x /bin/Shadowsocks-libev.sh; Shadowsocks-libev.sh
exit
}

fun_shadowsocksr () {
wget -O /bin/Shadowsocks-R.sh https://raw.githubusercontent.com/seth42sp/NEW-ADM-PRO/main/Install/Herramientas/Shadowsocks-R.sh
chmod +x /bin/Shadowsocks-R.sh; Shadowsocks-R.sh
exit
}

fun_shadowsocks () {
wget -O /bin/shadowsocks.sh https://raw.githubusercontent.com/seth42sp/NEW-ADM-PRO/main/Install/Herramientas/shadowsocks.sh
chmod +x /bin/shadowsocks.sh; shadowsocks.sh
exit
}

fun_tcp () {
wget -O /bin/tcp.sh https://raw.githubusercontent.com/seth42sp/NEW-ADM-PRO/main/Install/Herramientas/tcp.sh
chmod 777 /bin/tcp.sh; tcp.sh
exit
}

fun_blockbt () {
wget -O /bin/blockBT.sh https://raw.githubusercontent.com/seth42sp/NEW-ADM-PRO/main/Install/Herramientas/blockBT.sh
