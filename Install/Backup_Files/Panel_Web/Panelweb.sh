...
sleep 1
cd
wget https://raw.githubusercontent.com/seth42sp/NEW-ADM-PRO/main/Install/Panel_Web/panel_v10/plus.sql > /dev/null 2>&1
sleep 1
...
echo -e "\033[1;37mwget https://raw.githubusercontent.com/seth42sp/NEW-ADM-PRO/main/Install/Panel_Web/panel_v10/revenda/confpainel/inst && bash inst\033[0m"
...
sleep 1
cd
wget https://raw.githubusercontent.com/seth42sp/NEW-ADM-PRO/main/Install/Panel_Web/panel_v11/sshplus.sql > /dev/null 2>&1
sleep 1
